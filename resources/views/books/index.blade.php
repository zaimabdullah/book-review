...
@section('content')
  ...
  <div class="filter-container mb-4 flex">
    ...
    @endphp
    {{-- $filters contain key-value pair, look above --}}
    {{-- [...request()->query(), 'filter' => $key]) ===> to retain search field when user choose any tabs --}}
          ...
          <div class="flex flex-wrap items-center justify-between">
            ...
            <div>
              <div class="book-rating">
                <x-star-rating :rating="$book->reviews_avg_rating" /> {{-- IMPORTANT HERE --}}
              </div>
